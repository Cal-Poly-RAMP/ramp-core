...
(
  ...
  input  logic [0:0] clk ,
  input  DualMicroOp__9076e23e91e8c61e duop_in ,
  output logic [0:0] queue_empty ,
  output logic [0:0] queue_full ,
  input  logic [0:0] reset ,
  output MicroOp__910830ccb99b096f uop_out 
);
  localparam logic [4:0] __const__ISSUE_QUEUE_DEPTH  = 5'd16;
  localparam logic [0:0] __const__R_TYPE  = 1'd0;
  localparam logic [1:0] __const__S_TYPE  = 2'd2;
  localparam logic [1:0] __const__B_TYPE  = 2'd3;
  localparam logic [0:0] __const__I_TYPE  = 1'd1;
  localparam logic [2:0] __const__U_TYPE  = 3'd4;
  localparam logic [2:0] __const__J_TYPE  = 3'd5;
  MicroOp__910830ccb99b096f queue [0:15];
  logic [3:0] tail;
  ...
  always_ff @(posedge clk) begin : ff
    ...
    if ( 1'(__tmpvar__ff_collapse) ) begin
      ...
      queue[5'( __const__ISSUE_QUEUE_DEPTH ) - 5'd1] <= { 3'd0, 32'd0, 8'd0, 1'd0, 5'd0, 5'd0, 5'd0, 6'd0, 6'd0, 6'd0, 6'd0, 1'd0, 1'd0, 32'd0, 2'd0, 2'd0, 2'd0, 5'd0 };
    end
