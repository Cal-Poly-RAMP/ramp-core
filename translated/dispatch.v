...
(
  input  logic [0:0] clk ,
  input  MicroOp__55c259864d23ef8d in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output MicroOp__55c259864d23ef8d to_int_issue ,
  output MicroOp__55c259864d23ef8d to_mem_issue ,
  output MicroOp__55c259864d23ef8d to_rob 
);
...
(
  input  logic [0:0] clk ,
  input  DualMicroOp__8da14009c4c442a1 in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output DualMicroOp__8da14009c4c442a1 to_int_issue ,
  output DualMicroOp__8da14009c4c442a1 to_mem_issue ,
  output DualMicroOp__8da14009c4c442a1 to_rob 
);
  //-------------------------------------------------------------
  ...
  MicroOp__55c259864d23ef8d uop1_dispatch__in_;
  logic [0:0] uop1_dispatch__reset;
  logic [4:0] uop1_dispatch__rob_idx;
  MicroOp__55c259864d23ef8d uop1_dispatch__to_int_issue;
  MicroOp__55c259864d23ef8d uop1_dispatch__to_mem_issue;
  MicroOp__55c259864d23ef8d uop1_dispatch__to_rob;
  ...
  MicroOp__55c259864d23ef8d uop2_dispatch__in_;
  logic [0:0] uop2_dispatch__reset;
  logic [4:0] uop2_dispatch__rob_idx;
  MicroOp__55c259864d23ef8d uop2_dispatch__to_int_issue;
  MicroOp__55c259864d23ef8d uop2_dispatch__to_mem_issue;
  MicroOp__55c259864d23ef8d uop2_dispatch__to_rob;
