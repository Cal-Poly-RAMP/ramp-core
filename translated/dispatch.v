...
// PyMTL BitStruct MicroOp__02b95a544718c0e7 Definition
typedef struct packed {
  ...
  logic [3:0] fu_op;
  logic [4:0] rob_idx;
} MicroOp__02b95a544718c0e7;

// PyMTL BitStruct DualMicroOp__bea6b277e9712850 Definition
typedef struct packed {
  MicroOp__02b95a544718c0e7 uop1;
  MicroOp__02b95a544718c0e7 uop2;
} DualMicroOp__bea6b277e9712850;
...
(
  input  logic [0:0] clk ,
  input  MicroOp__02b95a544718c0e7 in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output MicroOp__02b95a544718c0e7 to_int_issue ,
  output MicroOp__02b95a544718c0e7 to_mem_issue ,
  output MicroOp__02b95a544718c0e7 to_rob 
);
  localparam logic [0:0] __const__INT_ISSUE_UNIT  = 1'd1;
  localparam logic [129:0] __const__NO_OP  = 130'd0;
...
(
  input  logic [0:0] clk ,
  input  DualMicroOp__bea6b277e9712850 in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output DualMicroOp__bea6b277e9712850 to_int_issue ,
  output DualMicroOp__bea6b277e9712850 to_mem_issue ,
  output DualMicroOp__bea6b277e9712850 to_rob 
);
  //-------------------------------------------------------------
  ...
  MicroOp__02b95a544718c0e7 uop1_dispatch__in_;
  logic [0:0] uop1_dispatch__reset;
  logic [4:0] uop1_dispatch__rob_idx;
  MicroOp__02b95a544718c0e7 uop1_dispatch__to_int_issue;
  MicroOp__02b95a544718c0e7 uop1_dispatch__to_mem_issue;
  MicroOp__02b95a544718c0e7 uop1_dispatch__to_rob;
  ...
  MicroOp__02b95a544718c0e7 uop2_dispatch__in_;
  logic [0:0] uop2_dispatch__reset;
  logic [4:0] uop2_dispatch__rob_idx;
  MicroOp__02b95a544718c0e7 uop2_dispatch__to_int_issue;
  MicroOp__02b95a544718c0e7 uop2_dispatch__to_mem_issue;
  MicroOp__02b95a544718c0e7 uop2_dispatch__to_rob;
