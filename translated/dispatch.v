...
(
  input  logic [0:0] clk ,
  input  MicroOp__c9b3dc01a081cc30 in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output MicroOp__c9b3dc01a081cc30 to_int_issue ,
  output MicroOp__c9b3dc01a081cc30 to_mem_issue ,
  output MicroOp__c9b3dc01a081cc30 to_rob 
);
  localparam logic [0:0] __const__INT_ISSUE_UNIT  = 1'd1;
  localparam logic [130:0] __const__NO_OP  = 131'd0;
...
(
  input  logic [0:0] clk ,
  input  DualMicroOp__080ef2515763923d in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output DualMicroOp__080ef2515763923d to_int_issue ,
  output DualMicroOp__080ef2515763923d to_mem_issue ,
  output DualMicroOp__080ef2515763923d to_rob 
);
  //-------------------------------------------------------------
  ...
  MicroOp__c9b3dc01a081cc30 uop1_dispatch__in_;
  logic [0:0] uop1_dispatch__reset;
  logic [4:0] uop1_dispatch__rob_idx;
  MicroOp__c9b3dc01a081cc30 uop1_dispatch__to_int_issue;
  MicroOp__c9b3dc01a081cc30 uop1_dispatch__to_mem_issue;
  MicroOp__c9b3dc01a081cc30 uop1_dispatch__to_rob;
  ...
  MicroOp__c9b3dc01a081cc30 uop2_dispatch__in_;
  logic [0:0] uop2_dispatch__reset;
  logic [4:0] uop2_dispatch__rob_idx;
  MicroOp__c9b3dc01a081cc30 uop2_dispatch__to_int_issue;
  MicroOp__c9b3dc01a081cc30 uop2_dispatch__to_mem_issue;
  MicroOp__c9b3dc01a081cc30 uop2_dispatch__to_rob;
