...
// PyMTL BitStruct MicroOp__910830ccb99b096f Definition
typedef struct packed {
  ...
  logic [1:0] fu_op;
  logic [4:0] rob_idx;
} MicroOp__910830ccb99b096f;

// PyMTL BitStruct DualMicroOp__9076e23e91e8c61e Definition
typedef struct packed {
  MicroOp__910830ccb99b096f uop1;
  MicroOp__910830ccb99b096f uop2;
} DualMicroOp__9076e23e91e8c61e;
...
(
  input  logic [0:0] clk ,
  input  MicroOp__910830ccb99b096f in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output MicroOp__910830ccb99b096f to_int_issue ,
  output MicroOp__910830ccb99b096f to_mem_issue ,
  output MicroOp__910830ccb99b096f to_rob 
);
...
(
  input  logic [0:0] clk ,
  input  DualMicroOp__9076e23e91e8c61e in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output DualMicroOp__9076e23e91e8c61e to_int_issue ,
  output DualMicroOp__9076e23e91e8c61e to_mem_issue ,
  output DualMicroOp__9076e23e91e8c61e to_rob 
);
  //-------------------------------------------------------------
  ...
  MicroOp__910830ccb99b096f uop1_dispatch__in_;
  logic [0:0] uop1_dispatch__reset;
  logic [4:0] uop1_dispatch__rob_idx;
  MicroOp__910830ccb99b096f uop1_dispatch__to_int_issue;
  MicroOp__910830ccb99b096f uop1_dispatch__to_mem_issue;
  MicroOp__910830ccb99b096f uop1_dispatch__to_rob;
  ...
  MicroOp__910830ccb99b096f uop2_dispatch__in_;
  logic [0:0] uop2_dispatch__reset;
  logic [4:0] uop2_dispatch__rob_idx;
  MicroOp__910830ccb99b096f uop2_dispatch__to_int_issue;
  MicroOp__910830ccb99b096f uop2_dispatch__to_mem_issue;
  MicroOp__910830ccb99b096f uop2_dispatch__to_rob;
