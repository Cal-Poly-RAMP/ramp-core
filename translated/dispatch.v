...
(
  input  logic [0:0] clk ,
  input  MicroOp__9272fe77ee466e9a in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output MicroOp__9272fe77ee466e9a to_int_issue ,
  output MicroOp__9272fe77ee466e9a to_mem_issue ,
  output MicroOp__9272fe77ee466e9a to_rob 
);
...
(
  input  logic [0:0] clk ,
  input  DualMicroOp__4a4469efa7c77da6 in_ ,
  input  logic [0:0] reset ,
  input  logic [4:0] rob_idx ,
  output DualMicroOp__4a4469efa7c77da6 to_int_issue ,
  output DualMicroOp__4a4469efa7c77da6 to_mem_issue ,
  output DualMicroOp__4a4469efa7c77da6 to_rob 
);
  //-------------------------------------------------------------
  ...
  MicroOp__9272fe77ee466e9a uop1_dispatch__in_;
  logic [0:0] uop1_dispatch__reset;
  logic [4:0] uop1_dispatch__rob_idx;
  MicroOp__9272fe77ee466e9a uop1_dispatch__to_int_issue;
  MicroOp__9272fe77ee466e9a uop1_dispatch__to_mem_issue;
  MicroOp__9272fe77ee466e9a uop1_dispatch__to_rob;
  ...
  MicroOp__9272fe77ee466e9a uop2_dispatch__in_;
  logic [0:0] uop2_dispatch__reset;
  logic [4:0] uop2_dispatch__rob_idx;
  MicroOp__9272fe77ee466e9a uop2_dispatch__to_int_issue;
  MicroOp__9272fe77ee466e9a uop2_dispatch__to_mem_issue;
  MicroOp__9272fe77ee466e9a uop2_dispatch__to_rob;
