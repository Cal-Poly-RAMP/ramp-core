...
(
  ...
  output MicroOp__55c259864d23ef8d uop ,
  ...
  // At /Users/curtisbucher/Desktop/ramp-core/src/cl/decode.py:160
  // @update
  // def decode_comb():
...
(
  output logic [63:0] busy_table ,
  input  logic [0:0] clk ,
  output DualMicroOp__8da14009c4c442a1 dual_uop ,
  ...
  logic [0:0] d1__reset;
  MicroOp__55c259864d23ef8d d1__uop;
  logic [0:0] d1__valid;
  ...
  logic [0:0] d2__reset;
  MicroOp__55c259864d23ef8d d2__uop;
  logic [0:0] d2__valid;
